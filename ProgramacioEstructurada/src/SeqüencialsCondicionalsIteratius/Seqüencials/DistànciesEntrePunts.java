...
public class DistànciesEntrePunts {
    public static void main(String[] args) {
        ...
        float totalDistance = distanceZeroToFirst + distanceFristToSecond + distanceSecondToThird + distanceThirdToForth + distanceForthToZero;
